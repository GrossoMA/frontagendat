      ...
      : countPagesData
        ? <footer className='flex justify-between py-2'>
          <button
            ...
            className='bg-slate-100 p-2 rounded-md text-blue-500 border-2 border-blue-500 font-semibold hover:bg-blue-500 hover:text-slate-100'
          >Anterior
          </button>
            ...
            {countPagesData?.map(page => {
              return (
                <button
                  ...
                  className={`${page === currentPageData ? 'bg-blue-500 text-slate-100 border-blue-500 ' : 'text-blue-500 '}w-10 h-10 rounded-md  border-2 hover:border-blue-500 font-semibold hover:bg-blue-500 hover:text-slate-100`}
                >
                  {page}
                </button>
              )
