...
import TipoEvento from "../components/TipoEventoSelector";
...
const [tipoEventoSeleccionado, setTipoEventoSeleccionado] = useState("");
  ...
  const handleTipoEventoChange = (tipoEvento) => {
    setTipoEventoSeleccionado(tipoEvento);
    console.log("Tipo de evento seleccionado:", tipoEvento);
    console.log("Tipo de tipoEventoSeleccionado:", tipoEventoSeleccionado);
  };




// eventosArray ahora contiene un arreglo de objetos con la estructura { value: id, label: nombre }

// Puedes usar eventosArray para cargarlo en un componente selector, por ejemplo:
// <Selector options={eventosArray} />
      ...
      <div className="form-container">
        <form onSubmit={handleSubmit} className="form space-y-4">
          <div>
            ...
            />
            <TipoEventoSelecto label="Tipo Evento" nombre="tipoDeEvento" handleTipoEventoChange={handleTipoEventoChange} />
            <p> Tipo seleccionado {tipoEventoSeleccionado}</p>
            {/* <TipoEventoSelector
            tiposDeEventos={eventosArray}
